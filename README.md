...
### Setting Up the Eclipse IDE and Project from Repository
...
For this codebase, it is recommended that you have the most recent Java OpenJDK version 11.0.12 and use the Eclipse IDE to run the program. 
## Attribution
